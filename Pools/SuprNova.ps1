        ...
        switch ($Info.Symbol) {
            ...
            'XVG' {
                switch ($Info.Algorithm) {
                    "lyra2v2" { $apiUrl = "https://xvg-lyra.suprnova.cc" }
                    "x17" { $apiUrl = "https://xvg-x17.suprnova.cc" }
                    "Myriad-Groestl" { $apiUrl = "https://xvg-mg.suprnova.cc" }
                }
            }
            'DGB' {
                switch ($Info.Algorithm) {
...
if (($Querymode -eq "core" ) -or ($Querymode -eq "Menu")) {
    ...
    $Pools += [pscustomobject]@{"coin" = "Verge"; "algo" = "lyra2v2"; "symbol" = "XVG"; "server" = "xvg-lyra.suprnova.cc"; "port" = "2295"; "location" = "US"};
    $Pools += [pscustomobject]@{"coin" = "Verge"; "algo" = "x17"; "symbol" = "XVG"; "server" = "xvg-x17.suprnova.cc"; "port" = "7477"; "location" = "US"};
    $Pools += [pscustomobject]@{"coin" = "Verge"; "algo" = "Myriad-Groestl"; "symbol" = "XVG"; "server" = "xvg-mg.suprnova.cc"; "port" = "7722"; "location" = "US"};
    $Pools += [pscustomobject]@{"coin" = "ZCash"; "algo" = "Equihash"; "symbol" = "ZEC"; "server" = "zec-apac.suprnova.cc"; "port" = "2142"; "location" = "Asia"};
    $Pools += [pscustomobject]@{"coin" = "ZCash"; "algo" = "Equihash"; "symbol" = "ZEC"; "server" = "zec-eu.suprnova.cc"; "port" = "2142"; "location" = "Europe"; "portSSL" = "2242"; "hostSSL" = "zen.suprnova.cc"; "SSL" = $true};
